...
_Branding note:_ the UI ships with a CSS-generated neon sigil so you can drop in real imagery later without editing markup. Adjust the `.logo-sigil` styles or swap in your own assets when ready.
